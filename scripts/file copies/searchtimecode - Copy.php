...
if ($perskin == 'true') {
  $corquery = $corquery . ' AND ' . $isperskin;
  $perskin = 'SKIN';
}
if ($bead == 'true') {
  $corquery = $corquery . ' AND ' . $isbead;
  $bead = 'B';
}
if ($mould == 'true') {
  $corquery = $corquery . ' AND ' . $ismould;
  $mould = 'M';
}
if ($glaze == 'true') {
  $corquery = $corquery . ' AND ' . $isglaze;
  $glaze = 'G';
}
if ($persetofskins == 'true') {
  $corquery = $corquery . ' AND ' . $issetsperskin;
  $setsperskin = 'SET';
}
