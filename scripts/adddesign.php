...
$corquery =
        "INSERT INTO designs (baseid, codeid, description, perskin, mould," 
        . " bead, glaze, persetofskins) VALUES (" . $baseid . ", " . $codeid 
        . ", '" . $description . "', " . $perskin . ", " . $mould . ", " 
        . $bead . ", " . $glaze . ", " . $persetofskins . ")";
$qry = mysql_query($corquery, $corcon);
if (!$qry) {
    die('Could not run add record query on line 12.' . $corquery . '     ' 
        . mysql_error());
}
